...
impl ToString for Instruction {
    fn to_string(&self) -> String {
        match self.addressing_mode {
            ...
            AddressingMode::Relative(val) => format!("{:0>2X} {:?} {:0>3}     ",
                                                     self.op_raw,
                                                     self.opcode,
                                                     val as i8),
...
impl Instruction {
    ...
    fn get_addressing_mode2(opcode: u8, operand: u8) -> AddressingMode {
        match opcode {
            ...
            0x85 |
            0x86 |
            0x84 => AddressingMode::ZeroPage(operand),
            ...
            0xf5 |
            0x95 |
            0x94 => AddressingMode::ZeroPageIndexedX(operand),
    ...
    fn get_addressing_mode3(opcode: u8, operand: u16) -> AddressingMode {
        match opcode {
            ...
            0x8d |
            0x8e |
            0x8c => AddressingMode::Absolute(operand),
            ...
            0x7e |
            0xfd |
            0x9d => AddressingMode::AbsoluteIndexedX(operand),
