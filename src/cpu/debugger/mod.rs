...
impl Instruction {
  ...
  fn get_addressing_mode1(opcode: u8) -> AddressingMode {
    match opcode {
      ...
      0x48 | 0x08 | 0x68 | 0x28 | 0x40 | 0x60 | 0x38 | 0xf8 | 0x78 | 0xaa |
      0xa8 | 0xba | 0x8a | 0x9a | 0x98 => AddressingMode::Implied,

      _ => { panic!("unexpected 1-byte instruction encountered."); }
    }
  }
  
  fn get_addressing_mode2(opcode: u8, operand: u8) -> AddressingMode {
    match opcode {
      0x65 | 0x25 | 0x06 | 0x24 | 0xc5 | 0xe4 | 0xc4 | 0xc6 | 0x45 | 0x55 |
      0xe6 | 0xa5 | 0xa6 | 0xa4 | 0x46 | 0x05 | 0x26 | 0x66 | 0xe5 | 0x85 |
      0x86 | 0x84 => AddressingMode::ZeroPage(operand),

      0x75 | 0x35 | 0x16 | 0xd5 | 0xd6 | 0xf6 | 0xb5 | 0xb4 | 0x56 | 0x15 |
      0x36 | 0x76 | 0xf5 | 0x95 | 0x94
          => AddressingMode::ZeroPageIndexedX(operand),

      0x69 | 0x29 | 0xc9 | 0xe0 | 0xc0 | 0x49 | 0xa9 | 0xa2 | 0xa0 | 0x09 |
      0xe9 => AddressingMode::Immediate(operand),
  ...
  fn get_addressing_mode3(opcode: u8, operand: u16) -> AddressingMode {
    match opcode {
      0x6d | 0x2d | 0x0e | 0x2c | 0xcd | 0xec | 0xcc | 0xce | 0x4d | 0xee |
      0x4c | 0x20 | 0xad | 0xae | 0xac | 0x4e | 0x0d | 0x2e | 0x6e | 0xed |
      0x8d | 0x8e | 0x8c => AddressingMode::Absolute(operand),

      0x7d | 0x3d | 0x1e | 0xdd | 0xde | 0x5d | 0xfe | 0xbd | 0xbc | 0x5e |
      0x1d | 0x3e | 0x7e | 0xfd | 0x9d
          => AddressingMode::AbsoluteIndexedX(operand),
