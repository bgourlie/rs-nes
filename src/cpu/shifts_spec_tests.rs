...
#[test]
fn asl_1() {
  shift_left_base_1(|ref mut cpu, val| {
    (cpu.asl(val), false)
  });
}
...
#[test]
fn asl_2() {
  shift_left_base_2(|ref mut cpu, val| {
    (cpu.asl(val), false)
  });
}
...
#[test]
fn asl_3() {
  shift_left_base_3(|ref mut cpu, val| {
    (cpu.asl(val), false)
  });
}
...
#[test]
fn lsr_1() {
  shift_right_base_1(|ref mut cpu, val| {
    (cpu.lsr(val), false)
  });
}
...
#[test]
fn lsr_2() {
  shift_right_base_2(|ref mut cpu, val| {
    (cpu.lsr(val), false)
  });
}
...
#[test]
fn lsr_3() {
  shift_right_base_3(|ref mut cpu, val| {
    (cpu.lsr(val), false)
  });
}
