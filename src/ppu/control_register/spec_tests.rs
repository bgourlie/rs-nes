...
fn base_nametable_addr() {
    ...
    let ppu_ctrl = ControlRegister::new(0b00000001);
    assert_eq!(0x2400, ppu_ctrl.base_name_table_addr());

    let ppu_ctrl = ControlRegister::new(0b00000010);
    assert_eq!(0x2800, ppu_ctrl.base_name_table_addr());

    let ppu_ctrl = ControlRegister::new(0b00000011);
...
fn vram_addr_increment() {
    ...
    let ppu_ctrl = ControlRegister::new(0b00000100);
...
fn sprite_pattern_table_addr() {
    ...
    let ppu_ctrl = ControlRegister::new(0b00001000);
...
fn background_pattern_table_addr() {
    ...
    let ppu_ctrl = ControlRegister::new(0b00010000);
...
fn sprite_size() {
    ...
    let ppu_ctrl = ControlRegister::new(0b00100000);
...
fn ppu_mode() {
    ...
    let ppu_ctrl = ControlRegister::new(0b01000000);
...
fn nmi_on_vblank_start() {
    ...
    let ppu_ctrl = ControlRegister::new(0b10000000);
