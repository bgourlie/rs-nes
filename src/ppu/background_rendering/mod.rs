...
pub struct BackgroundRendering {
    ...
    attr_shift_register_1: u8,
    attr_shift_register_2: u8,
    attribute_latch: u8,
    nametable_latch: u8,
...
impl BackgroundRendering {
    ...
    pub fn tick_shifters(&mut self, fine_x: u8) {
        let low_bit = (self.pattern_low_shift_register & 1) as u8;
        let high_bit = ((self.pattern_high_shift_register & 1) << 1) as u8;
        self.current_pixel = low_bit | high_bit;
