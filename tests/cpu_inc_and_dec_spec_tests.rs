...
fn inc_base_1<F>(inc: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
...
fn inc_base_2<F>(inc: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
...
fn inc_base_3<F>(inc: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
...
fn dec_base_1<F>(dec: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
...
fn dec_base_2<F>(dec: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
...
fn dec_base_3<F>(dec: F) where F : Fn(&mut Cpu6502, u8) -> u8 {
